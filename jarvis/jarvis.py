...
def wishme():
     ...
     if hour>=0 and hour<12:
        var.set("Good morning Rajat Chandel! What a sunny day ")
        windows.update()
        speak(" Good Morning Rajat Chandel! What a sunny day") 

     elif hour>=12 and hour<16:
        var.set("Good Afternoon Rajat Chandel!")
        windows.update()
        speak("Good Afternoon Rajat Chandel!")

     else:
        var.set("Good Evening Rajat Chandel!")
        windows.update()
        speak("Good Evening Rajat Chandel!")
...
def play():
   ...
   while True:
       ...
       if ('exit') in input:
          ...
          codepath = "D:\\python vs\\dist\\tic_tac_toe\\tic_tac_toe.exe" 
          ...
          speak("what do you want me to seach for")
...
var.set('Welcome Rajat!')
label1.pack()

frames = [PhotoImage(file ='D:\jarvis\Assistant.gif' , format = 'gif -index %i' %(i)) for i in range(100)]
windows.title('NORY')

label = Label(windows, width = 600 , height = 400)
label.pack()
